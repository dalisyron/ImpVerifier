...
public class ImpLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FALSE", "IF", "ELSE", "WHILE", "ASSIGN", "PLUS", "TIMES", "EQUAL", "LEQ", 
			"GEQ", "SEMICOLON", "GREATER", "LESS", "NOT", "AND", "OR", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "REQUIRES", "ENSURES", "INVARIANT", "FORALL", 
			"EXISTS", "IMPLIES", "DOUBLECOLON", "MINUS", "INTDIV", "RETURNS", "ARGSEP", 
			"NEW", "COLON", "INTMOD", "ID", "LETTER", "INT", "WS", "SL_COMMENT"
		};
	}
