...
public class ImpParser extends Parser {
	...
	public static final int
		...
		RULE_whileStatement = 11, RULE_invariantList = 12, RULE_parenthesizedCondition = 13, 
		RULE_assignStatement = 14, RULE_varDecl = 15, RULE_type = 16, RULE_expr = 17, 
		RULE_reference = 18, RULE_exprList = 19;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ifStatement", "whileStatement", "invariantList", "parenthesizedCondition", 
			"assignStatement", "varDecl", "type", "expr", "reference", "exprList"
		};
	}
